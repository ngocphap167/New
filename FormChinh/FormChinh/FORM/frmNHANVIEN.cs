...
namespace FormChinh.FORM
{
    public partial class frmNHANVIEN : Form
    {
        ...
        {
            string sql;
            sql = "SELECT Manhanvien,Tennhanvien,Gioitinh,Diachi,Dienthoai,Ngaysinh FROm tblNhanvien where TrangThai<>'Xoa' or TrangThai is null";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblNhanvien(Manhanvien,Tennhanvien,Gioitinh, Diachi,Dienthoai, Ngaysinh) VALUES (N'" + txtManhanvien.Text.Trim() + "',N'" + txtTennhanvien.Text.Trim() + "',N'" + txtGioitinh.Text.Trim() + "',N'" + txtDiachi.Text.Trim() + "','" + mskDienthoai.Text + "','" + functions.ConvertDateTime(mskNgaysinh.Text.Trim()) + "')";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn xóa không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                sql= "UPDATE tblNhanvien SET TrangThai='Xoa' Where Manhanvien=N'" + txtManhanvien.Text.Trim() + "'";
